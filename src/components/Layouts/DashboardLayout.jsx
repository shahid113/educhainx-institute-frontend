    ...
    <div className="flex h-screen bg-gradient-to-br from-white to-gray-100 text-gray-800">
      ...
      <aside className="w-64 bg-white/60 backdrop-blur-lg border-r border-gray-200 shadow-sm flex flex-col">
        ...
        <nav className="flex-1">
          <Link
            to="/dashboard"
            className={`block py-3 px-6 text-sm font-medium transition ${location.pathname === "/dashboard"
          ...
          <Link
            ...
            className={`block py-3 px-6 text-sm font-medium transition ${location.pathname === "/dashboard/issue-certificate"
                ? "bg-orange-100 text-orange-700"
                : "hover:bg-gray-50"
              }`}
          >
          ...
          <Link
            to="/dashboard/generate-certificate"
            className={`block py-3 px-6 text-sm font-medium transition ${location.pathname === "/dashboard/generate-certificate"
                ? "bg-orange-100 text-orange-700"
                : "hover:bg-gray-50"
              }`}
          >
